...
//    override fun getTasks(): Either<DomainError, List<data.TaskData>> = listOf(
//        data.TaskData(
//            name = "Сделать ДЗ",
...
//    getIndexModel(petRepo, taskRepo).flatMap { renderTemplate("Index.kte", it) }
//        .fold({
...
//    new.renderTemplate("Settings.kte", Unit)
//        .fold({
//            Response(Status.INTERNAL_SERVER_ERROR).body(it.toString())
//        }) {
//            Response(Status.OK).body(it)
...
//    new.renderTemplate("Tasks.kte", tasksModel)
//        .fold({
//            Response(Status.INTERNAL_SERVER_ERROR).body(it.toString())
//        }) {
//            Response(Status.OK).body(it)
...
//).toLens()
//
//private fun taskLens(request: Request) : data.TaskData {
...
//        priority = data.Priority.valueOf(priority.uppercase()),
...
//    new.renderTemplate("Task.kte", taskLens(request))
//        .fold({
//            Response(Status.INTERNAL_SERVER_ERROR).body(it.toString())
//        }) {
//            Response(Status.OK).body(it)
